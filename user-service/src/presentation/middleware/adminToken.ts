...
export const adminToken = (req: AuthenticatedRequest, res: Response, next: NextFunction): any => {
    const tokens = {
    ...
    const accessToken =  tokens.adminAccessToken;
    const refreshToken =  tokens.adminRefreshToken;
